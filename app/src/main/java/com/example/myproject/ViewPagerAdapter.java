...
public class ViewPagerAdapter extends PagerAdapter {
    ...
    Context context;
    int sliderAllImages[] = {R.drawable.img1,R.drawable.img2,R.drawable.img3};
...
//        error ditected ---------------------------------------------------
        LinearLayout slideImage = (LinearLayout) view.findViewById(R.id.sliderImage);
        ...
        slideImage.setBackgroundResource(sliderAllImages[position]);
        slideTitle.setText(this.sliderAllTitle[position]);
        slideDesc.setText(this.sliderAllDesc[position]);
